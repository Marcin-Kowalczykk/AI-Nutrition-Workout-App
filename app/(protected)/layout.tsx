    ...
    <>
      ...
      <div className="flex min-h-0 flex-1 flex-col">
        <SidebarProvider defaultOpen={true}>
          <AppSidebar />
          <SidebarInset className="flex min-h-0 flex-1 flex-col w-full md:w-[calc(100%-var(--sidebar-width-expanded))] md:peer-data-[state=collapsed]:w-[calc(100%-var(--sidebar-width-collapsed))] md:min-h-full md:h-full">
            {isMobile ? (
