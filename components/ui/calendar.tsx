  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: cn(
          "absolute inset-x-0 top-0 flex w-full items-center justify-center gap-1",
          defaultClassNames.nav
        ),
        button_previous: cn(
          buttonVariants({ variant: buttonVariant }),
          "h-[--cell-size] w-[--cell-size] select-none p-0 aria-disabled:opacity-50 hidden",
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "text-sm"
            : "[&>svg]:text-muted-foreground flex h-8 w-full items-center justify-between rounded-md px-2 text-sm [&>svg]:size-3.5",
